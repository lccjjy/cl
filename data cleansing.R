...
#merge
data_cleaned <- merge(assigned_to,bug_status,by=c("bug_id","update_time","reporter_id"))
data_cleaned <- merge(data_cleaned,cc,by=c("bug_id","update_time","reporter_id"))
data_cleaned <- merge(data_cleaned,component,by=c("bug_id","update_time","reporter_id"))
data_cleaned <- merge(data_cleaned,op_sys,by=c("bug_id","update_time","reporter_id"))
data_cleaned <- merge(data_cleaned,priority,by=c("bug_id","update_time","reporter_id"))
data_cleaned <- merge(data_cleaned,product,by=c("bug_id","update_time","reporter_id"))
data_cleaned <- merge(data_cleaned,resolution,by=c("bug_id","update_time","reporter_id"))
